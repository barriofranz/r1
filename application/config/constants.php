...
define("MAX_REQUEST_TRIES",10);
define("BASE_PATH", "http://" . $_SERVER['HTTP_HOST'] . "/r1/");
define("JQUERY_PATH","tools/jquery/jquery-1.11.3.min.js");
define("BOOTSTRAP_MAIN_CSS_PATH","tools/bootstrap/v3.3.5/css/bootstrap.min.css");
