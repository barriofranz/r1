...
!function($) {
            ...
            var template = 
            	'<span class="button-checkbox bootstrap-checkbox">' +
            		'<button type="button" class="btn clearfix'+additionalButtonStyle+'">' +
	                    ...
	                    '<span class="fa '+this.options.checkedClass+'" style="display:none;"></span>' +
	                    '<span class="fa '+this.options.uncheckedClass+'"></span>' +
	                    '<span class="fa '+this.options.indeterminateClass+'" style="display:none;"></span>' +
    ...
    $.fn.checkbox.defaults = {
        ...
        indeterminateClass: 'fa-check-indeterminate',
        defaultState: false,
        defaultEnabled: true,
